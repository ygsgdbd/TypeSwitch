...
<img src="TypeSwitch/Resources/Assets.xcassets/AppIcon.appiconset/icon_256x256.png" width="96" alt="TypeSwitch 图标">
...
它把常用操作集中在菜单栏里：为每个 App 选择输入法策略，设置未配置应用规则，并在前台 App 切换时自动切到对应输入法。
